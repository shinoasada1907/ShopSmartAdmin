...
class ProductsProvider with ChangeNotifier {
  ...
  List<ProductModel> findByCategory({required String categoryName}) {
    List<ProductModel> listCategory = products
  ...
  List<ProductModel> seachProduct(
      {required String searchText,
      required List<ProductModel> passListProduct}) {
    List<ProductModel> listSearch = passListProduct
